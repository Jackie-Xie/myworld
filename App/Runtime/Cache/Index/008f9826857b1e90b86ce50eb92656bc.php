	...
	<div id="arc">
		...
		<div class="arc_left_box_list">
			<ul class="article_list">
				...
				<?php if(is_array($top)): foreach($top as $key=>$tops): ?><li><a href="<?php echo U(GROUP_NAME . '/Article/index',array('aid'=> $tops['aid']));?>" class="istop"><?php echo ($tops["title"]); ?></a><em><?php echo (date('Y-m-d',$tops["time"])); ?></em></li><?php endforeach; endif; ?>
				<?php if(is_array($bottom)): foreach($bottom as $key=>$bottoms): ?><li><a href="<?php echo U(GROUP_NAME . '/Article/index',array('aid'=> $bottoms['aid']));?>"><?php echo ($bottoms["title"]); ?></a><em><?php echo (date('Y-m-d',$bottoms["time"])); ?></em></li><?php endforeach; endif; ?>
			</ul>
			<div class="manu page">
				<?php echo ($page); ?>
			</div>
