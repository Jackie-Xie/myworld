...
function() {
	...
	o(),
	{
		getPic: function(o, n) {
			...
			e = Math.floor(o / 7);
			return "http://pic.ttpod.cn/singerpic/" + t + "/" + e + "/" + o + "_" + n + ".jpg"
		},
...
function() {
	var t = "http://v1.ard.h.itlily.com/",
	e = "http://ttus.ttpod.com/",
	o = "http://fm.api.ttpod.com/",
	i = "http://so.ard.iyyin.com/",
	s = "http://ting.hotchanson.com/",
	a = "http://advise.ttpod.cn/",
	d = "http://lp.music.ttpod.com/",
	c = "./play/ajax.php",
	n = {
		getitlily: c + "?type=album&id={channelid}&page={page}&size={size}",
		getposter: c + "?type=poster",
		search_filter: "/myworld/data/search_ids.php",
		...
		taglist: "http://fm.api.ttpod.com/taglist?image_type=180_90",
		getdtmusicsbytagid: "http://fm.api.ttpod.com/songlist?tagid={tagid}&page={page}&size={size}&image_type=200_200",
		...
		getBgData: "/myworld/data/bg.php",
		checkSong: i + "check.do?song_id={song_id}",
		sendPicLyricError: "http://admin.lrc.ttpod.com/ttuser/feed?level={level}&lptype={lptype}&lrcid={lrcid}&arpic={arpic}&title={title}&artist={artist}&songid={songid}",
		...
		sinaLogin: "https://api.weibo.com/oauth2/authorize?scope=follow_app_official_microblog&forcelogin=true&client_id=3374293008&display=default",
		qqLogin: "https://graph.qq.com/oauth2.0/authorize?scope=upload_pic,add_topic,get_user_info&client_id=100240447&response_type=code",
		top2013: {
			billboard: {
			...
			singer: Ttpod.core.getURI("/myworld/data/top2013.php")
		}
	};
...
function() {
	...
	this.outImgUrl = function(s, a) {
		if (a = a || Ttpod.config.path.singer, s) {
			if (s.indexOf("http") < 0 && (s = "http://ayyc.ttpod.com/" + s), "true" == a) return ' src="' + s + '"'
		} else s = a;
	...
	this.downVoiceTips = '       <div class="tips-title-wrap">            <div class="tips-title-box">               <span class="tips-title">下载提示</span>               <a class="close">X</a>           </div>           <div class="tips-msg">               <p>《中国好声音》独家歌曲，只在天天动听手机客户端</p>               <a href="http://www.ttpod.com/download" target="_blank" data-ds="tip" class="down-btn J_downMobile">一键安装</a>            </div>       </div>    '
});
...
function() {
	...
	W = null,
	Y = null,
	Q = "http://app.ttdtweb.com/dongting/styles/images/defaultSinger-5d99da.jpg",
	Z = 0,
	et = !1,
	tt = !1,
	ot = !1,
	...
	ct = function(e) {
		...
		function o() {
			...
			$("#J_shareWrap").hover(function() {
				...
				if (e) {
					var o = "http://www.6html.com/radio/?song_id=" + e.song_id,
					n = "我在听《" + e.singer_name + " - " + e.song_name + "》，你也来听听吧！ (分享自@随心听 ，好音质 #清风电台#)";
			...
			l = {
				...
				callback: function(n) {
					...
					a && $.fn.fly && $.fn.fly({
						startObj: a,
						endObj: $("#btnListNew"),
						flySrc: "http://app.ttdtweb.com/dongting/styles/images/fly_icon-e832ea.png",
						endWidth: 40,
						endHeight: 25,
						x: -100,
						y: -50
	...
	function e() {
		...
		function() {
			...
			$.browser.msie && "7.0" == $.browser.version ? !1: ($.fn.fly && $.fn.fly({
				startObj: $(this),
				endObj: $("#btnListNew"),
				flySrc: "http://app.ttdtweb.com/dongting/styles/images/fly_add-12f080.png",
				endWidth: 25,
				endHeight: 25,
				x: -25,
				y: -30
...
function() {
	...
	function n(o) {
		...
		case "tb":
			...
			break;
		case "91":
			window.external.GoToModule("application", "appstore", "http://itunesapp.sj.91.com/SoftDetail.aspx?platform=iPhone&ClientVer=5.0&fw=7.0&id=483336353");
			break;
		default:
			e(o.url)
		} else e(o.url)
	...
	d = "佚名",
	m = {
		_styleSrc: "http://www.dongting.com/",
		_musicDownloadSrc: "http://www.dongting.com/",
	...
	return {
		init: function() {
			"baidu" == Ttpod.config.from ? $.getScript("http://wap.baidu.com/static/as/bdsuite/js/BaiduExternal.js",
			function() {
				s = new BaiduExternal(),
				s.init("music", 2002)
			}) : "ali" == Ttpod.config.from ? $.getScript("http://static01.zhushou.yunos.com/thirdparty/zhushou_api.js",
			function() {
				Ali.registerSearch(function(o) {
					location.href = "union.html#a=searchlist&q=" + o
				})
			}) : "lenovo" === Ttpod.config.from ? $.getScript("http://app.sj.lenovomm.com/scripts/leplus-ao.js",
			function() {}) : "tb" === Ttpod.config.from && $.getScript("http://v2.tongbu.com/appshare/api/partnersdownload?appleid=483336353")
		},
		openUrl: e,
		isUnion: r,
		getUnionF: t,
...
function() {
	...
	function i() {
		Ttpod.config.isOpen || $.cookie("authorize") || $.getScript("http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=js",
		function() {
	...
	function s() {
		...
		function() {
			return Ttpod.unionApi.isUnion() ? (downUrl = Ttpod.unionApi.getUnionF() ? "android" == Ttpod.config.client.os ? "http://d1.ttpod.com/download/android/" + Ttpod.unionApi.getUnionF() + "/TTPod_Android.apk": "ios" == Ttpod.config.client.os ? "https://itunes.apple.com/cn/app/id483336353?mt=8": "http://www.ttpod.com/download": "http://www.ttpod.com/download", Ttpod.unionApi.softwareDownload({
				from: Ttpod.config.from,
				os: Ttpod.config.client.os,
				...
				vername: "7",
				size: 9961472,
				icon: "http://app.ttdtweb.com/dongting/images/app-6374b8.png"
			}), Ttpod.core.log({
				a: "downApp",
